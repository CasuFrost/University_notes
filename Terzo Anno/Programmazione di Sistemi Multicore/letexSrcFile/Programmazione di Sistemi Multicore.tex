...
\end{lstlisting}
\redText{Attenzione : le pagine successive, riguardanti gli ultimi argomenti di openMP sono una bozza temporanea.}
\section{Schedluing Loops e Costrutti di Programmazione}
\includepdf[pages=-]{openMP_finalpart.pdf}
...
(4 bytes), possiamo caricare al massimo 50G operandi al secondo. Se eseguiamo una sola
operazione con ogni operando, possiamo eseguire 50GFLOP/s, che paragonata al massimo della
