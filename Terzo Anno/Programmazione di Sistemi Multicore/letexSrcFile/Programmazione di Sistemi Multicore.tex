...
Ci sono 4 blocchi = 16 thread, un thread per ogni elemento della matrice. È necessria un'osservazione\begin{itemize}
    \item il thread che si occupa dell'elemento $(0,0)$ accede alla riga $0$ di $M$ e alla colonna $0$ di $N$
    \item il thread che si occupa dell'elemento $(1,0)$, è contenuto nello stesso blocco del thread precedente, ed accede alla riga $1$ di $M$ e alla colonna $0$ di 
