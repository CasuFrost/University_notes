...
void(*func_ptr)(int)=func; /*puntatore a funzione in cui se ne specifica anche il tipo 
                           [int] del parametro*/
\end{lstlisting}
Convenzionalmente, la funzione del thread è di tipo puntatore a void ed ha come parametro di ingresso 
...
sincronizzati correttamente. Tale problema è noto come \textbf{race condition} ed ha comportato la nascita di 
