...
\begin{center}
    ...
    \end{figure}\end{center}
\redText{ Finire capitolo 2 \\The requirements \\
- engineering process\\
- design process\\
- stage testing generalizza,in un caso di un Planet drive e in caso agile \\
- software prototype pro e contro \\
\\
iniziare il capitolo 3 agile software development \\
- plan base vs agile \\
- principles of agile methods\\
- the extreme programming release cycle ( un tipo di agile)}
