...
\begin{center}
    \includegraphics[width=0.8\textwidth ]{images/CircuitazioneCampoMagnetico2.eps}
\end{center}
...
\end{quote}
In situazioni di simmetria, la legge di Ampere permette di calcolare il campo magnetico.
\end{document}