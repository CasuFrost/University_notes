...
\sapbox{\textbf{Problema aperto} : La seguente proposizione non è stata dimostrata, e tutt'ora non si sa se sia vera o falsa $$ C\in LOG\implies P\subseteq LOG$$ 
...
\teo{(Immerman-Szelepcsényi)} La classe $NLOG$ è chiusa rispetto al complemento $$NLOG=coNLOG$$\dimo{}\redText{TODO}
