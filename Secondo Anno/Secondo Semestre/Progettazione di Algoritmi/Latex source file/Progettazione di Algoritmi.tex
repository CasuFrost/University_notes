...
soluzione più grande di $Sol^\star$, che per ipotesi è già ottimale.\begin{center}
    \includegraphics[width=0.4\textwidth ]{images/dimPropIntervalli.eps}
\end{center}
Sia $[a_j,b_j]$ l'intervallo di $Sol^\star$ che si interseca con $I_{k+1}$ 
...
Siccome $b_{k+1}>L$ e $I_{k+1}$ è disgiunto dagli elementi di $Sol_k$, si ha che $a_j>L$\begin{center}
    \includegraphics[width=0.7\textwidth ]{images/dimPropIntervalli2.eps}
\end{center}
\end{document}