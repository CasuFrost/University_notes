...
\codee{\}}
\subsection{Ponti sui Grafi non Diretti}
\hphantom{a}
\begin{center}
...
da $x$ a $V_H$ e da $V_H$ ad $x$, quindi il grafo $\nicefrac{G}{H}$ è fortemente connesso. $\blacksquare$\acc 
...
connesso assegnato, non è da confondersi con lo stack \code{S} del DFS iterativo.\acc
...
\codee{\}}\acc
Il problema di questo algoritmo, è la riga in cui si controlla se un nodo è una C-radice.
\end{document}