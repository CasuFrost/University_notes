...
$$\begin{matrix}
    \lnot\big(\\\exists part \;\exists arrivo \;\exists g\;\; OrarioGiornoVolo(g) \\  
...
\newpage
\section{Appunti}
Ricordare tutti i vincoli esterni relativi alle prenotazion dei voli in relazione  
con le date checkin e checkout di eventuale hotel\acc 
\end{document}