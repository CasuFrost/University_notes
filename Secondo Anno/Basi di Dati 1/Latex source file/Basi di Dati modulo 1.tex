...
\end{center}
I record che finiranno negli stessi bucket, saranno per definizione della funzione hash, vicini fra loro, si accederà in 
...
ne in lettura ne in scrittura. Entrambi gli stati vengono rilasciati con il metodo \code{unlock(X)}.\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        \rowcolor[HTML]{EFEFEF} 
        rlocked          & \code{wlock(X)}               & T attende il rilascio                                                                    \\ \hline
        \rowcolor[HTML]{EFEFEF} 
        wlocked          & \code{wlock(X)}               & T attende il rilascio                                                                     \\ \hline
        \end{tabular}
\end{center}
