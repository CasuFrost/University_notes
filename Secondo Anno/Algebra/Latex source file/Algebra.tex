...
\begin{figure}[h]
    \centering{
    \includegraphics[width=0.8\textwidth ]{images/sottospazio.png}
    }
\end{figure}
...
Tali vettori, si dicono \textbf{linearmente indipendenti} se ogni combinazione lineare
 ...
 \subsubsection{Esempio Geometrici}
 ...
 due vettori sono linearmente indipendenti se non giaciono sulla stessa retta.
\end{document}