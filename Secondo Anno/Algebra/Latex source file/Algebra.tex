...
\(\varphi : \mathbb{Z_n}\rightarrow G\) definita come \(\varphi : [m] \rightarrow g^m\), 
...
\begin{enumerate}
    ...
    \item  Se \(H\le G =\left\langle g\right\rangle \) e \(|G|=n=o(n)\), allora 
...
se \(o(g)\) divide \(t\) si ha \(t=k\cdot o(n)+r\) con \(r<o(g)\), 
...
\(1=(ab)^t=a^tb^t\implies a^t=b^{-t}\implies o(a)=o(b^{-t})\). Ciò suggerisce la 
...
conseguenza, che \(m=n-1\). \(\blacksquare\)
...
\(k\) è associato il sottogruppo \(\left\langle g^{\frac{n}{k}}\right\rangle\), quindi avremo i sottogruppi : 
\begin{itemize}
    \item \(k=6\implies \left\langle g^{2}\right\rangle\implies \left\langle [2]\right\rangle\)
\end{itemize}
\end{document}