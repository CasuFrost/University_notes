...
\begin{figure}[h]
    \centering{
    \includegraphics[width=0.7\textwidth ]{images/LogoAlgebra.jpg}
    }
\end{figure}
\newpage 
...
si arriva al seguente risultato :\begin{quote}
    ...
    \end{center}
\end{quote}
\subsection{Sistemi di Equazioni Congruenziali}
...
\end{equation}
Dove ogni argomento del modulo, è coprimo con tutti gli altri. Tale sistema si dice di tipo \textit{cinese}. Un sistema 
...
definizione:\begin{deff}
    ...
    \end{center}
\end{deff}\subsubsection{Nucleo di un omomorfismo}
