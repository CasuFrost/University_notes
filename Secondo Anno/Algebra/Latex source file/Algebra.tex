...
elementi, si considera un nuovo valore, ossia \(h_l=\dfrac{a_{l_i}}{p_i}\), e si somma, tutta la 
\(l\)-esima riga con \(h_l\), facendo così, con tutti gli elementi \(a_{{i+1}_i},a_{{i+2}_i}\dots,a_{{n}_i}\) 
