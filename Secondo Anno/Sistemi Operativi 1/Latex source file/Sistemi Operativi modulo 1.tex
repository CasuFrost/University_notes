...
\begin{itemize}
    ...
    \item \textbf{Comunicazion tra processi} - per far comunicare due processi, o si utilizza un canale unico di 
...
processo appena clonato, se esso è il processo figlio, il PID sarà 0, per questo si entrà nel blocco 
