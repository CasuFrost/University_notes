...
in cui i nodi sono i possibili stati, ed ogni nodo \(i\) ha un arco che lo collega con tutti gli altri noti, etichettato 
...
Risulta altrettanto più naturalle, disporre le probabilità che ogni stato ha di passare ad un altro nell'istante temporale 
