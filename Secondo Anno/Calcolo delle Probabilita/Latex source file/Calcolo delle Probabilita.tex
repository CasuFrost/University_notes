...
Consideriamo il lancio di 2 dadi identici, senza considerare l'ordine. Abbiamo che l'evento elementare 
...
\end{equation}
\newpage\subsection{Il Multinomio}
...
\section{Spazi di Probabilità Prodotto}
...
\subsection{Schema di Bernoulli}
